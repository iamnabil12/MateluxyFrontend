...
const MOCK_AGENTS = [
    { name: "Tanvir Almas", role: "Agent", image: "/Image/profile_1.png" },
    { name: "William Yong", role: "CEO", image: "/Image/profile_2.png" },
    { name: "Liwen Yan", role: "Managing Director", image: "/Image/profile_3.png" },
    { name: "Abdullah Mahi", role: "Marketing", image: "/Image/profile_4.png" },
    { name: "Tanvir Almas", role: "Agent", image: "/Image/profile_5.png" },
];
                                ...
                                <Box className="relative">
                                    ...
                                    >
                                        ...
                                        <Box className="w-[54px] h-[54px] rounded-full overflow-hidden relative z-10">
                                            <Image src={agent.image} alt="Avatar" fill className="object-cover" />
                                        </Box>
